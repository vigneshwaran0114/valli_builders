	...
	theme: {
		...
		extend: {
			...
			animation: {
				...
				'construction-slide-in': 'construction-slide-in 0.8s ease-out',
				'crane-lift': 'crane-lift 1.2s ease-out',
				'blueprint-draw': 'blueprint-draw 2s ease-in-out',
				'float-construction': 'float-construction 3s ease-in-out infinite',
				'pulse-glow': 'pulse-glow 2s ease-in-out infinite',
				'build-up': 'build-up 1s ease-out'
			}
		}
	},
